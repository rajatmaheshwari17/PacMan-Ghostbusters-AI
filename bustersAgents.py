...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for action in legal:
            ...
            distanceToGhost = self.distancer.getDistance(successorPosition, closestGhostPos)
            if distanceToGhost < minActionDistance:
                bestAction = action
                minActionDistance = distanceToGhost
